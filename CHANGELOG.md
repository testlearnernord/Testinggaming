...
## 1.3.1 — 2025-09-18
- Desktop-Layout: Touch-Joystick, Sprint-Button und Mobile-Context-Layer entfernt, Fokus auf Maus + WASD.
- Maussteuerung: Spieler blickt in Maus-Richtung, Linksklick löst Kontextaktionen aus.
- Canvas-Setup vereinfacht, wodurch der schwarze Bildschirm durch Touch-Abfragen nicht mehr auftreten kann.
