...
let primeAudioUnlock = null;
if (typeof sfxExports === "object" && sfxExports) {
  const candidate = sfxExports.primeAudioUnlock;
  if (typeof candidate === "function") {
    primeAudioUnlock = candidate;
  }
}
if (!primeAudioUnlock) {
  primeAudioUnlock = function primeAudioUnlockFallback() {};
}
